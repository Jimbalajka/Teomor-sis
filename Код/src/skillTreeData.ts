...
const nodes: SkillNode[] = [
 ...
 { id: 'feat_arcane_recovery', x: -540, y: -120, label: 'Восстановление маны', zone: 'magic', category: 'feat', cost: { type: 'OR', amount: 1 }, requirements: { parentIds: ['ts_concentration'], requiredSpecialization: { zone: 'magic', level: 3 } }, description: '' },
 ...
 { id: 'feat_portent', x: -520, y: -680, label: 'Предзнаменование', zone: 'magic', category: 'feat', cost: { type: 'OR', amount: 2 }, requirements: { parentIds: ['ts_divination'], requiredSpecialization: { zone: 'magic', level: 3 } }, description: '' },
 ...
 fork('feat_sor_twinned', -1000, 480, 'Двойной каст', 'wisdom', 'feat_sor_metamagic', 'fork_sor_meta', '', 2),
 fork('feat_sor_quickened', -940, 520, 'Ускоренный каст', 'wisdom', 'feat_sor_metamagic', 'fork_sor_meta', '', 2),
 fork('feat_sor_wild', -860, 580, 'Дикая магия', 'wisdom', 'ts_sor_draconic', 'fork_sor_blood', '', 1),
 ...
 fork('feat_shaman_totem', -640, 680, 'Тотемный зов', 'wisdom', 'st_shaman', 'fork_divine', '', 1),
 fork('feat_druid_beast', -680, 740, 'Облик зверя', 'wisdom', 'st_druid', 'fork_divine', '', 2),
 fork('feat_priest_heal', -540, 780, 'Массовое исцеление', 'wisdom', 'st_priest', 'fork_divine', '', 2),
 fork('feat_paladin_smite', -420, 760, 'Кара', 'wisdom', 'st_paladin', 'fork_divine', '', 1),
...
function addRoadFork(
 ...
 description: (st.t === 'n' ? 'Веха. ' : '') + (st.desc ?? ''),
 });
 prev = id;
 });
 forks.forEach((f, fi) => {
 ...
 description: `${CHOICE}Оплот. ${f.desc}`,
 });
 });
}
...
addRoadFork('sch_wizardry', -520, -300, 'magic', [
 ...
 { idSuffix: 'glass', label: 'Стеклянная пушка', group: 'wiz_keystone', desc: '' },
...
addRoadFork('sch_berserk', 520, -300, 'strength', [
 ...
 { idSuffix: 'blood', label: 'Кровавый туман', group: 'berserk_keystone', desc: '' },
]);
...
addRoadFork('sch_ranged', 560, 440, 'dexterity', [
 ...
 { idSuffix: 'point', label: 'В упор', group: 'ranged_keystone', desc: '' },
 { idSuffix: 'far', label: 'Дальнобойщик', group: 'ranged_keystone', desc: '' },
]);
...
addRoadFork('sch_stealth', 420, 540, 'dexterity', [
 ...
 { idSuffix: 'assassin', label: 'Палач', group: 'stealth_keystone', desc: '' },
]);
addRoadFork('sch_cybernetics', 180, 420, 'dexterity', [
 ...
 { idSuffix: 'ghost', label: 'Призрачный протокол', group: 'cyber_keystone', desc: '' },
]);
...
addRoadFork('sch_witchcraft', -520, 300, 'wisdom', [
 ...
 { idSuffix: 'wild', label: 'Дикий пакт', group: 'witch_keystone', desc: '' },
]);
addRoad('sch_psionics', -540, 460, 'wisdom', [
 ...
 { t: 'k', label: 'Разум без границ', desc: '' },
]);
addRoadFork('sch_divine', -420, 560, 'wisdom', [
 ...
 { idSuffix: 'wrath', label: 'Гнев небес', group: 'divine_keystone', desc: '' },
]);
addRoadFork('sch_leader', -280, 560, 'wisdom', [
 ...
 { idSuffix: 'face', label: 'Лик лидера', group: 'leader_keystone', desc: '' },
]);
