...
| **Layout** | путь/ствол + развилки; легенда: синий=путь, серый=общие, чёрный=профы/углубления; LS_DATA `v19` |
| **PR rule** | каждая пачка правок = **новый** PR (не дописывать в старый) |
| **Эталон** | скрины: синий путь / серый центр / чёрные профы — одинаково на всех путях |
